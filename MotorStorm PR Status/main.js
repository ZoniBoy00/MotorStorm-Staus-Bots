...
const activities = [
  { type: ActivityType.Watching, message: "Monitoring MotorStorm PR server" },
...
async function checkServerStatus() {
  try {
    ...
    // Update total players count - now only PR
    totalPlayers = data.motorstorm_pr.summary.total_players
