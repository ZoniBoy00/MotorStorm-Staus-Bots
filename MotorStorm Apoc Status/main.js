...
// Debug setting
const DEBUG = false // Set to false to disable detailed logging
...
const activities = [
  { type: ActivityType.Watching, message: "Monitoring MotorStorm Apocalypse server" },
...
async function checkServerStatus() {
  try {
    ...
    // Update total players count - now only MSA
    totalPlayers = data.motorstorm_msa.summary.total_players
  } catch (error) {
